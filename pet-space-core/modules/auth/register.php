...
function psc_register_render( int $step, string $error ): void {
    ...
    <head>
        ...
        <?php wp_head(); ?>
        <style><?php echo psc_register_css(); ?></style>
    </head>
...
/* ============================================================
   10. CSS
   ============================================================ */
function psc_register_css(): string { return '
/* ── 리셋 & 기본 ── */
...
input.psc-reg-input,
textarea.psc-reg-input,
select.psc-reg-input {
    width: 100%;
    padding: 15px 16px;
    background: #f4f6f9;
...
input.psc-reg-input:focus,
textarea.psc-reg-input:focus,
select.psc-reg-input:focus {
    border-color: #224471;
    background: #fff;
    box-shadow: 0 0 0 3px rgba(34,68,113,.08);
}
input.psc-reg-input::placeholder,
textarea.psc-reg-input::placeholder { color: #b0b8c1; }
textarea.psc-reg-input { resize: vertical; min-height: 100px; }
select.psc-reg-input { cursor: pointer; }

/* 비밀번호 인풋 패딩 (토글 버튼 공간) */
input.psc-reg-input[type="password"],
input.psc-reg-input[type="text"] {
    padding-right: 48px;
}
...
.psc-reg-btn:hover  { background: #1a3459; }
...
.psc-reg-btn--outline:hover { background: #e5e8eb; }
