...
.psc-coupon-card__badge {
    ...
    background: linear-gradient(135deg,#224471,#1a3459);
...
.psc-coupon-card__btn {
    background: #224471; color:#fff; border:none;
    padding: 8px 18px; border-radius:8px;
    font-size:.85rem; font-weight:700; cursor:pointer;
    transition: background .15s, opacity .15s;
}
.psc-coupon-card__btn:hover { background:#1a3459; opacity:1; }
...
.psc-issued-coupon__copy-btn:hover { background:#1a3459; }
...
.psc-issued-coupon__close {
    ...
    background:#224471; border:none; font-size:1.1rem;
    color:#fff; cursor:pointer; z-index:10;
    line-height:1; padding:0;
    width:32px; height:32px; border-radius:50%;
}
.psc-issued-coupon__close:hover { background:#1a3459; }
