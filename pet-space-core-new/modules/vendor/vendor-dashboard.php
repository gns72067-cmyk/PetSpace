...
.psc-dash-btn{
    ...
    cursor:pointer;text-decoration:none;border:none;transition:opacity .15s;font-family:inherit;
}
.psc-dash-btn:hover{opacity:.85;}
.psc-dash-btn--primary{background:#111;color:#fff;}
...
.psc-dash-form-group select:focus{border-color:#111;}
