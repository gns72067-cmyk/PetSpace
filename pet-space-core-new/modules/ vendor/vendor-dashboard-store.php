...
function psc_dash_page_store( int $store_id, int $user_id ): void {
    ...
    /* ── 리뷰 인증 설정 ── */
    $cur_verify_type = get_field( 'review_verify_type', $store_id ) ?: 'receipt';
    $cur_gps_radius  = get_field( 'review_gps_radius',  $store_id ) ?: 300;
    ...
    <div class="psc-dash-section">
        ...
        <form method="post" class="psc-dash-form" enctype="multipart/form-data">
            ...
            <!-- ════ 리뷰 인증 설정 ════ -->
            <div class="psc-dash-card" id="section-review-verify">
                <div class="psc-dash-card__header">
...
function psc_dash_save_store( int $store_id ): true|WP_Error {
    ...
    update_field( 'review_verify_type', $verify_type, $store_id );
    update_field( 'review_gps_radius',  $gps_radius,  $store_id );
